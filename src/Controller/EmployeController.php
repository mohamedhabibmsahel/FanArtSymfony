...
class EmployeController extends AbstractController
{
    ...
    /**
     * @Route("/payer/{id}", name="employe_payer", methods={"GET"})
     */
    public function payer(Employe $employe,$id,EmployeRepository $employeRepository): Response
    {
    ...
    /**
     * @Route("/placer/{id}", name="employe_placer", methods={"GET"})
     */
    public function placer(Employe $employe,$id,EmployeRepository $employeRepository): Response
    {

        return $this->render('employe/placer.html.twig', [
            'employe' => $employe,
        ]);
    }

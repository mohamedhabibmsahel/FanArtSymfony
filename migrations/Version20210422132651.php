 ...
 */
final class Version20210422132651 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE disponible disponible VARCHAR(25) DEFAULT \'\'\'dispo\'\'\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE disponible disponible VARCHAR(25) CHARACTER SET utf8mb4 DEFAULT \'dispo\' NOT NULL COLLATE `utf8mb4_general_ci`');

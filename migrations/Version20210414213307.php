 ...
 */
final class Version20210414213307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recprod ADD idprod INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_F4C04383667BE037 ON recprod (idprod)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recprod DROP FOREIGN KEY FK_F4C04383667BE037');
        $this->addSql('DROP INDEX IDX_F4C04383667BE037 ON recprod');
        $this->addSql('ALTER TABLE recprod DROP idprod');
